...
class GuestController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $guests = $em->getRepository('AppBundle:Guest')->findAll();
    ...
    {
        $guest = new Guest();
        $form = $this->createForm('AppBundle\Form\GuestType', $guest);
    ...
    {
        $deleteForm = $this->createDeleteForm($guest);
        $editForm = $this->createForm('AppBundle\Form\GuestType', $guest);
